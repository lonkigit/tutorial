...
url = 'http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word=' + word + '&ct=201326592&ic=0&lm=-1&width=&height=&v=flip'
...
for each in pic_url:
    ...
    filename = '/home/lonki/pythonspider/pic/%s-%s.jpg' %(word,str(i))
    fp = open(filename,'wb')
